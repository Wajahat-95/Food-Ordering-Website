  ...
  return (
    <div className={styles.container}>
      <div className={styles.wrapper}>
        <h1 className={styles.title}>You will pay 200 after delivery</h1>
        ...
        <div className={styles.item}>
          ...
          <input type="text" placeholder='+92-312-3577654' className={styles.input}/>
        </div>
        <div className={styles.item}>
          <label className={styles.label}>Address</label>
          <textarea  
          rows={5}
          placeholder="246 Judicial Society"
          type='text'
